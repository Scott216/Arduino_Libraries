...
void Wtv020sd16p::reset(){
  ...
  delay(750);  //srg changed from 300 to 750 per sparkfun comments suggestion https://www.sparkfun.com/products/11125 from member 395251
}
...
void Wtv020sd16p::sendCommand(unsigned int command) {
  ...
  delay(50);  // srg changed from 20 to 50 per sparkfun comments suggestion https://www.sparkfun.com/products/11125 from member 395251
}
