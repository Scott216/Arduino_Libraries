...
SRG Changes
 7/3/12 - changed all the feed IDs from unsigned int to unsigned long
...
{
protected:
	ERxPachube(const char* APIKey, unsigned long feedId);
...
{
public:
	ERxPachubeDataOut(const char* APIKey, unsigned long feedId);
...
{
public:
	ERxPachubeDataIn(const char* APIKey, unsigned long feedId);
