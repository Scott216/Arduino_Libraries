...
// HTTP header
//
const char http_get_header[] PROGMEM = "GET /v2/feeds/" ;
// feed id
const char http_host_key_header[] PROGMEM = ".csv HTTP/1.1\nHost: api.pachube.com\nX-PachubeApiKey: " ;
// API key
// \n\n

const char http_put_header[] PROGMEM = "PUT /v2/feeds/" ;
// feed id
// http_host_key_header
// API key
const char http_content_header[] PROGMEM = "\nContent-Type: text/csv\nContent-Length: " ;
const char http_connection_header[] PROGMEM = "\nConnection: close\n\n" ;


// Debug message
// 
const char debug_getHttpStatusCodeFromHeader[] PROGMEM = "getHttpStatusCodeFromHeader" ;
const char debug_waitForRepsonse[] PROGMEM = "Waiting for response." ;
const char debug_timeout[] PROGMEM = "Time out" ;
const char debug_success[] PROGMEM = "SUCCESS" ;
const char debug_fail[] PROGMEM = "FAIL" ;
const char debug_error_data_stream_length[] PROGMEM = "ERROR data stream length: " ;
const char debug_data_start[] PROGMEM = "Data start from the empty line above" ;
const char debug_find_r[] PROGMEM = "Find \\r" ;
const char debug_find_n[] PROGMEM = "Find \\n" ;
const char debug_calculate_http_content_length[] PROGMEM = "Calculate http content length:" ;
...
ERxPachube::ERxPachube(const char* APIKey, unsigned long feedId) 
...
unsigned long ERxPachube::getFeedId() const
{
	return mFeedId;
}
...
ERxPachubeDataOut::ERxPachubeDataOut(const char* APIKey, unsigned long feedId)
...
ERxPachubeDataIn::ERxPachubeDataIn(const char* APIKey, unsigned long feedId)
: ERxPachube(APIKey, feedId)
{
}
